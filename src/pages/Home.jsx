...
import { Plus, BookOpen, Calendar, ChevronRight, ClipboardList, Search, X, GraduationCap, Car } from 'lucide-react';
  ...
  return (
    <div>
      <div className="flex justify-between items-start mb-8">
        <div>
          <h2 className="text-3xl font-bold text-slate-900">Auswertungen</h2>
